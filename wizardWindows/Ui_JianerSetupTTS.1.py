...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 782, 665))
        ...
        sizePolicy.setHeightForWidth(self.ttsRate.sizePolicy().hasHeightForWidth())
        self.ttsRate.setSizePolicy(sizePolicy)
        ...
        self.StrongBodyLabel.setFont(font2)

        self.gridLayout.addWidget(self.StrongBodyLabel, 5, 0, 1, 1)
        ...
        sizePolicy.setHeightForWidth(self.ttsVolume.sizePolicy().hasHeightForWidth())
        self.ttsVolume.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.ttsPitCh.sizePolicy().hasHeightForWidth())
        self.ttsPitCh.setSizePolicy(sizePolicy)
        ...
        # self.horizontalLayout_7 = QHBoxLayout(self.Edit_Icon_Settings_5)
        ...
        # self.IconWidget_6 = IconWidget(self.Edit_Icon_Settings_5)
        ...
        # self.verticalLayout_7.addItem(self.verticalSpacer_35)

        # self.TitleLabel_6 = TitleLabel(self.Edit_Icon_Settings_5)
        # self.TitleLabel_6.setObjectName(u"TitleLabel_6")
        # self.TitleLabel_6.setMaximumSize(QSize(16777215, 50))
        # self.TitleLabel_6.setFont(font3)

        # self.verticalLayout_7.addWidget(self.TitleLabel_6)

        # self.SubtitleLabel_7 = SubtitleLabel(self.Edit_Icon_Settings_5)
        ...
        # self.verticalLayout_7.addItem(self.verticalSpacer_36)


        # self.horizontalLayout_7.addLayout(self.verticalLayout_7)

        # self.sovitsAPI = LineEdit(self.Edit_Icon_Settings_5)
        # self.sovitsAPI.setObjectName(u"sovitsAPI")
        # sizePolicy1 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
        # sizePolicy1.setHorizontalStretch(0)
        # sizePolicy1.setVerticalStretch(0)
        # sizePolicy1.setHeightForWidth(self.sovitsAPI.sizePolicy().hasHeightForWidth())
        # self.sovitsAPI.setSizePolicy(sizePolicy1)
        # self.sovitsAPI.setMaximumSize(QSize(16777215, 16777215))

        # self.horizontalLayout_7.addWidget(self.sovitsAPI)
        ...
        # # self.gridLayout.addWidget(self.Edit_Icon_Settings_5, 6, 0, 1, 1) # GPT-Sovits 暂时无法发布
    ...
    def retranslateUi(self, Form):
        ...
        # self.StrongBodyLabel.setText(QCoreApplication.translate("Form", u"    GPT-Sovits", None)) #GPT-Sovits 暂时无法发布
        ...
        # self.TitleLabel_6.setText(QCoreApplication.translate("Form", u"\u63a5\u53e3\u5730\u5740", None))
        # self.SubtitleLabel_7.setText(QCoreApplication.translate("Form", u"GPT-Sovits \u6717\u8bfb\u97f3\u9891\u751f\u6210\u7684 API \u94fe\u63a5", None))
    # retranslateUi
